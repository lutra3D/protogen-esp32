...
#define FACE_NEOPIXEL_OUT_L 32 // GPIO pin for left Neopixel matrix
#define FACE_NEOPIXEL_OUT_R 33 // GPIO pin for right Neopixel matrix
...
constexpr uint8_t DATA_PIN_EARS = 27;
